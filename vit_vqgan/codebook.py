...
class CodeBook(nn.Module):
    ...
    def __init__(
        ...
        # 创建码本，nn.Embedding 就是一个可学习的二维表（num_codebook_vectors × latent_dim）
    ...
    def forward(self, z: torch.Tensor) -> torch.Tensor:
        ...
        # print('min_distance_indices', min_distance_indices.shape)
        ...
        # 这里的 min_distance_indices shape 是 (B*H*W,)，即把 batch、height、width 展平成一维，每个位置对应一个 patch/像素的码本索引
